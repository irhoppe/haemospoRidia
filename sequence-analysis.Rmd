...
## This chunk is an attempt to trim the consensus reads to the 479-bp target region. However, given the variability in read quality and length (some are already <<479 bp after quality trimming), I don't feel that it's doing well.
## At present, this code hasn't been fully integrated into the analysis, and represents more of a test.
